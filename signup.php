            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-input" name="id_num" id="id_num" placeholder="ID Number" required <?php echo isset($idNum)?"value=".warpQuote($idNum):""; ?>>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="tel" class="form-input" name="mobile_no" id="mobile_no" placeholder="Mobile Number" required <?php echo isset($mobileNum)?"value=".warpQuote($mobileNum):""; ?>>
                        </div>
                        <div class="form-group">
...
if(isset($_POST['username'])){
  ...
  $dateOfBirth = $_POST['dateOfBirth'];
    ...
    if($repassword == $password){
      $userValue = warpQuote($username).",".warpQuote($password).",".warpQuote($fullname).",".warpQuote($email);
      $applicantValue = warpQuote($idNum).",".warpQuote($idType).",".warpQuote($dateOfBirth).",".warpQuote($mobileNum);
      $sql1 = "INSERT INTO users (username, password, fullname, email) VALUES (".$userValue.");";
      $sql2 = "INSERT INTO applicant (IDNumber, IDType, dateOfBirth, mobileNo) VALUES (".$applicantValue.");";
      ...
      else if(!(($idType) == "ic" || isset($idType) == "passport")){
  			$error = "Invalid ID Type. ID Type only can be ic or passport.";
        echo "<script type='text/javascript'>alert('$error');</script>";
  			unset($idType);
  		}
      else{
